class sportCar extends Car{
    ...
    public sportCar(String brand, String model, int year, String fuelType, double engineSize, int range, int topSpeed, int percentFuel, String transmissionType) {
